...
public class MeuCompiladorLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"SE", "SENAO", "ENTAO", "ENQUANTO", "PARA", "ATE", "PASSO", "FIMSE", 
			"FIMPARA", "FIMENQUANTO", "ESCREVA", "LEIA", "INTEIRO", "REAL", "TEXTO", 
			"COMENTARIO_LINHA", "COMENTARIO_BLOCO", "ID", "NUMERO_INTEIRO", "NUMERO_REAL", 
			"VALOR_TEXTO", "WS"
		};
	}
